...
<section class="categories" id="categories">
  ...
  <div class="categories-grid fade-in">
    <div class="cat-card"><img src="https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=600&q=80" alt="Shirts" loading="lazy" /></div>
    <div class="cat-card"><img src="https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?w=600&q=80" alt="Trousers" loading="lazy" /></div>
    <div class="cat-card"><img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80" alt="Shoes" loading="lazy" /></div>
  </div>
</section>
...
<section class="testimonials" id="testimonials">
  ...
  <div class="testi-grid">
    <div class="testi-card">
      <p class="testi-quote">Essy Haven’s products exceeded my expectations. High-quality and elegant!</p>
      <div class="testi-author">
        <img class="testi-avatar" src="https://randomuser.me/api/portraits/women/68.jpg" alt="Customer">
        <div>
          <div class="testi-name">Sophia L.</div>
          <div class="testi-role">Fashion Enthusiast</div>
        </div>
      </div>
    </div>
    <div class="testi-card">
      <p class="testi-quote">Love the collection! It’s trendy and perfect for daily wear.</p>
      <div class="testi-author">
        <img class="testi-avatar" src="https://randomuser.me/api/portraits/men/32.jpg" alt="Customer">
        <div>
